...
public interface IActivityManager extends IInterface {
    ...
    /**
     * @deprecated Replaced in API 31 (Android 12) by {@link #registerReceiverWithFeature(IApplicationThread, String, String, String, IIntentReceiver, IntentFilter, String, int, int)}
     */
    @Deprecated
    Intent registerReceiverWithFeature(IApplicationThread caller, String callerPackage,
                                       String callingFeatureId, IIntentReceiver receiver,
                                       IntentFilter filter, String requiredPermission,
                                       int userId, int flags) throws RemoteException;
    ...
    /**
     * @deprecated Replaced in Android M with {@link #broadcastIntent(IApplicationThread, Intent, String, IIntentReceiver, int, String, Bundle, String[], int, Bundle, boolean, boolean, int)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Replaced in API 31 (Android 12) by {@link #broadcastIntentWithFeature(IApplicationThread, String, Intent, String, IIntentReceiver, int, String, Bundle, String[], String[], int, Bundle, boolean, boolean, int)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Replaced in API 33 (Android 13) by {@link #broadcastIntentWithFeature(IApplicationThread, String, Intent, String, IIntentReceiver, int, String, Bundle, String[], String[], String[], int, Bundle, boolean, boolean, int)}
     */
    @Deprecated
    @RequiresApi(Build.VERSION_CODES.S)
    int broadcastIntentWithFeature(IApplicationThread caller, String callingFeatureId,
    ...
    int broadcastIntentWithFeature(IApplicationThread caller, String callingFeatureId,
                                   Intent intent, String resolvedType, IIntentReceiver resultTo,
                                   int resultCode, String resultData, Bundle map,
                                   String[] requiredPermissions, String[] excludePermissions,
                                   String[] excludePackages, int appOp, Bundle options,
                                   boolean serialized, boolean sticky, int userId)
            throws RemoteException;
    ...
    /**
     * @deprecated Repalced in API 29 (Android Q) by {@link #getContentProviderExternal(String, int, IBinder, String)}
    ...
    /**
     * @deprecated Replaced in Android M by {@link #startService(IApplicationThread, Intent, String, String, int)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Replaced in Android O by {@link #startService(IApplicationThread, Intent, String, boolean, String, int)}
     */
    @Deprecated
    @RequiresApi(Build.VERSION_CODES.M)
    ComponentName startService(IApplicationThread caller, Intent service,
    ...
    /**
     * @deprecated Replaced in Android R by {@link #startService(IApplicationThread, Intent, String, boolean, String, String, int)}
     */
    @Deprecated
    ...
    int bindIsolatedService(IApplicationThread caller, IBinder token, Intent service,
                            String resolvedType, IServiceConnection connection, int flags,
    ...
    /**
     * @deprecated Replaced in Android LOLLIPOP_MR1 by {@link #checkUriPermission(Uri, int, int, int, int, IBinder)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Replaced in Android O by {@link #revokeUriPermission(IApplicationThread, String, Uri, int, int)}
     */
    @Deprecated
    ...
    IIntentSender getIntentSenderWithFeature(int type, String packageName, String featureId,
                                             ...
                                             String[] resolvedTypes, int flags, Bundle options, int userId) throws RemoteException;
    ...
    void setServiceForeground(ComponentName className, IBinder token,
                              int id, Notification notification, int flags, int foregroundServiceType) throws RemoteException;
    ...
    @RequiresApi(Build.VERSION_CODES.TIRAMISU)
    void stopAppForUser(String packageName, int userId) throws RemoteException;

    void forceStopPackage(String packageName, int userId) throws RemoteException;

    @RequiresApi(Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
    void forceStopPackageEvenWhenStopping(String packageName, int userId) throws RemoteException;
    ...
    /**
     * @deprecated Replaced in API 34 (Android 14) by {@link #killApplication(String, int, int, String, int)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Replaced in API 34 (Android 14) by {@link #sendIntentSender(IApplicationThread, IIntentSender, IBinder, int, Intent, String, IIntentReceiver, String, Bundle)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Replaced in API 34 (Android 14) by {@link #restartUserInBackground(int, int)}
     */
    @Deprecated
    int restartUserInBackground(int userId) throws RemoteException;

    @RequiresApi(Build.VERSION_CODES.UPSIDE_DOWN_CAKE)
    int restartUserInBackground(int userId, int userStartMode) throws RemoteException;
    ...
    ParceledListSlice<ApplicationExitInfo> getHistoricalProcessExitReasons(String packageName,
                                                                           int pid, int maxNum, int userId) throws RemoteException;
