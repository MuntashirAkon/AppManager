...
\subsubsection{Lineage OS}\label{subsubsec:lineage-os} %%##$aot-lineage-os-title>>
%%!!aot-lineage-os<<
...
on the right-hand side to enable it and skip to §\ref{subsubsec:adb-mode-on-app-manager}.
%%!!>>
...
\subsubsection{Enable ADB mode on App Manager}\label{subsubsec:adb-mode-on-app-manager} %%##$adb-mode-am-title>>
%%!!adb-mode-am<<
...
\begin{warning}{Warning}
    ...
    §\ref{subsubsec:enable-adb-over-tcp-via-pc-or-mac} again.
\end{warning}
%%!!>>
