...
\subsection{Do I have to enable ADB over TCP everytime I restart?} %%##$restart-title>>
%%!!restart<<
...
\subsection{Cannot enable USB debugging. What to do?} %%##$usb-debugging-title>>
%%!!usb-debugging<<
See §\cref{subsec:enable-usb-debugging} in Chapter \cref{ch:guides}.
%%!!>>

\subsection{Can I block tracker or any other application components using ADB over TCP?} %%##$block-tracker-title>>
%%!!block-tracker<<
...
\subsection{Which features can be used in ADB mode?} %%##$feature-adb-title>>
%%!!feature-adb<<
