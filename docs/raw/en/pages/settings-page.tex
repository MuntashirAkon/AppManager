...
\subsection{App Theme}\label{subsec:app-theme} %%##$app-theme-title>>
%%!!app-theme<<
Configure in-app theme.
%%!!>>

\subsection{Screen Lock}\label{subsec:screen-lock} %%##$screen-lock-title>>
%%!!screen-lock<<
...
\subsection{Selected Users}\label{subsec:selected-users} %%##$selected-users-title>>
%%!!selected-users<<
...
\subsection{Enable/Disable Features}\label{subsec:enable/disable-features} %%##$enable-disable-features-title>>
...
\subsection{Saved APK Name Format}\label{subsec:saved-apk-name-format} %%##$saved-apk-name-format-title>>
...
\subsection{Import/Export Keystore}\label{subsec:import/export-keystore} %%##$import-export-keystore-title>>
