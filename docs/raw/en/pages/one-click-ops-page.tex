...
\section{1-Click Ops Page}\label{sec:1-click-ops-page} %%##pages_oneclickops-section==title>>
%%!!pages_oneclickops-section<<
...
\subsection{Block/Unblock Trackers}\label{subsec:block-unblock-trackers} %%##pages_oneclickops-block-unblock-trackers==title>>
%%!!pages_oneclickops-block-unblock-trackers<<
This option can be used to block or unblock the ad/tracker components from the installed apps.
...
\subsection{Block Components\dots}\label{subsec:block-components-dots} %%##pages_oneclickops-block-components-dots==title>>
%%!!pages_oneclickops-block-components-dots<<
This option can be used to block certain app components denoted by the signatures.
...
\subsection{Set Mode for App Ops\dots}\label{subsec:set-mode-for-app-ops-dots} %%##pages_oneclickops-set-mode-for-app-ops-dots==title>>
%%!!pages_oneclickops-set-mode-for-app-ops-dots<<
...
\subsection{Back up}\label{subsec:1-click-back-up} %%##pages_oneclickops-1-click-back-up==title>>
%%!!pages_oneclickops-1-click-back-up<<
...
\subsection{Restore}\label{subsec:1-click-restore} %%##pages_oneclickops-1-click-restore==title>>
%%!!pages_oneclickops-1-click-restore<<
