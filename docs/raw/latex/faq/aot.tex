\section{ADB over TCP}\label{sec:faq:adb-over-tcp} %%##faq_aot-section_title>>

\subsection{Do I have to enable ADB over TCP everytime I restart?} %%##faq_aot-restart_title>>
%%!!faq_aot-restart<<
...
\subsection{Cannot enable USB debugging. What to do?} %%##faq_aot-usbdebugging_title>>
%%!!faq_aot-usbdebugging<<
See §\cref{subsec:enable-usb-debugging} in Chapter \cref{ch:guides}.
%%!!>>

\subsection{Can I block tracker or any other application components using ADB over TCP?} %%##faq_aot-blocktracker_title>>
...
\subsection{Which features can be used in ADB mode?} %%##faq_aot-featureadb_title>>
%%!!faq_aot-featureadb<<
