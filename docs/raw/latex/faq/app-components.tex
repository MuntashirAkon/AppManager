\section{App Components}\label{sec:faq:app-components} %%##faq_appcomponents-section==title>>

\subsection{What are the app components?}\label{subsec:faq:what-are-app-components} %%##faq_appcomponents-whatareappcomponents==title>>
%%!!faq_appcomponents-whatareappcomponents<<
...
\subsection{How are the tracker or other components blocked in AM? What are its limitations?} %%##faq_appcomponents-limitations==title>>
%%!!faq_appcomponents-limitations<<
...
\subsection{Why are the components blocked by AM not detected by other related apps?} %%##faq_appcomponents-detectbyrelatedapps==title>>
%%!!faq_appcomponents-detectbyrelatedapps<<
...
\subsection{Does app components blocked by other tools retained in AM?} %%##faq_appcomponents-othertoolsretainedinam==title>>
%%!!faq_appcomponents-othertoolsretainedinam<<
...
\subsection{What happened to the components blocked by AM which are also blocked by other tools?} %%##faq_appcomponents-alsoblockedbyothertools==title>>
%%!!faq_appcomponents-alsoblockedbyothertools<<
...
\subsection{What is instant component blocking?}\label{subsec:faq:what-is-instant-component-blocking} %%##faq_appcomponents-whatiscomponentblocking==title>>
%%!!faq_appcomponents-whatiscomponentblocking<<
...
\subsection{Tracker classes versus tracker components}\label{subsec:tracker-classes-versus-tracker-components} %%##faq_appcomponents-trackerclassesversustrackercomponents==title>>
%%!!faq_appcomponents-trackerclassesversustrackercomponents<<
...
\subsection{How to unblock the tracker components blocked using 1-Click Ops or Batch Ops?}\label{subsec:faq:how-to-unblock-tracker-components} %%##faq_appcomponents-howtounblock==title>>
%%!!faq_appcomponents-howtounblock<<
