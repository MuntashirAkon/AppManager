\section{ADB over TCP}\label{sec:adb-over-tcp} %%##guide_aot-section==title>>
%%!!guide_aot-section<<
...
\subsection{Enable developer options}\label{subsec:enable-developer-options} %%##guide_aot-enabledevoptions==title>>

\subsubsection{Location of developer options}\label{subsubsec:location-of-developer-options} %%##guide_aot-locationdevoptions==title>>
%%!!guide_aot-locationdevoptions<<
...
\subsubsection{How to enable developer options} %%##guide_aot-howenabledevoptions==title>>
%%!!guide_aot-howenabledevoptions<<
...
\subsection{Enable USB debugging}\label{subsec:enable-usb-debugging} %%##guide_aot-enableusbdbg==title>>
...
\subsubsection{Xiaomi (MIUI)} %%##guide_aot-miuiusbdbg==title>>
%%!!guide_aot-miuiusbdbg<<
Enable \textbf{USB debugging (security settings)} as well.
%%!!>>

\subsubsection{Huawei (EMUI)} %%##guide_aot-emuiusbbdbg==title>>
%%!!guide_aot-emuiusbbdbg<<
...
\subsubsection{LG} %%##guide_aot-lgusbdbg==title>>
%%!!guide_aot-lgusbdbg<<
Make sure you have \textbf{USB tethering} enabled.
%%!!>>

\subsubsection{Troubleshooting} %%##guide_aot-troubleshootingusbdbg==title>>
%%!!guide_aot-troubleshootingusbdbg<<
...
\subsection{Setup ADB on PC or Mac}\label{subsec:setup-adb-on-pc-or-mac} %%##guide_aot-setupadbonpc==title>>
%%!!guide_aot-setupadbonpc<<
...
\subsubsection{Windows} %%##guide_aot-setupadbwin==title>>
%%!!guide_aot-setupadbwin<<
\begin{enumerate}
...
\subsubsection{macOS} %%##guide_aot-setupadbmac==title>>
%%!!guide_aot-setupadbmac<<
\begin{enumerate}
    \item Download the latest version of
...
\subsubsection{Linux} %%##guide_aot-setupadblnx==title>>
%%!!guide_aot-setupadblnx<<
\begin{enumerate}
...
\subsection{Configure ADB over TCP}\label{subsec:configure-adb-over-tcp} %%##guide_aot-configureaot==title>>

\subsubsection{Lineage OS}\label{subsubsec:lineage-os} %%##guide_aot-aotlineage==title>>
%%!!guide_aot-aotlineage<<
...
\subsubsection{Enable ADB over TCP via PC or Mac}\label{subsubsec:enable-adb-over-tcp-via-pc-or-mac} %%##guide_aot-enableaotviapc==title>>
%%!!guide_aot-enableaotviapc<<
...
\subsubsection{Enable ADB mode on App Manager}\label{subsubsec:adb-mode-on-app-manager} %%##guide_aot-adbmodeam==title>>
%%!!guide_aot-adbmodeam<<
...
\subsubsection{Stop ADB over TCP}\label{subsubsec:stop-adb-over-tcp} %%##guide_aot-stopaot==title>>
%%!!guide_aot-stopaot<<
...
\subsection{References}\label{subsec:references} %%##guide_aot-references==title>>
%%!!guide_aot-references<<
\begin{enumerate}
