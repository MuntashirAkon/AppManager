\section{Interceptor Page}\label{sec:interceptor-page} %%##pages_interceptorpage-section==title>>
%%!!pages_interceptorpage-section<<
...
\subsection{Intent Filters}\label{subsec:intent-filters} %%##pages_interceptorpage-intent-filters==title>>
%%!!pages_interceptorpage-intent-filters<<
...
\subsubsection{Action}\label{subsubsec:action} %%##pages_interceptorpage-action==title>>
%%!!pages_interceptorpage-action<<
...
\subsubsection{Data}\label{subsubsec:data} %%##pages_interceptorpage-data==title>>
%%!!pages_interceptorpage-data<<
...
\subsubsection{MIME Type}\label{subsubsec:mime-type} %%##pages_interceptorpage-mime-type==title>>
%%!!pages_interceptorpage-mime-type<<
...
\subsubsection{Categories} %%##pages_interceptorpage-categories==title>>
%%!!pages_interceptorpage-categories<<
...
\subsubsection{Flags} %%##pages_interceptorpage-flags==title>>
%%!!pages_interceptorpage-flags<<
...
\subsubsection{Extras} %%##pages_interceptorpage-extras==title>>
%%!!pages_interceptorpage-extras<<
...
\subsubsection{URI} %%##pages_interceptorpage-uri==title>>
%%!!pages_interceptorpage-uri<<
...
\subsection{Matching Activities}\label{subsec:matching-activities} %%##pages_interceptorpage-matching-activities==title>>
%%!!pages_interceptorpage-matching-activities<<
...
\subsection{Reset to Default}\label{subsec:interceptor-reset-to-default} %%##pages_interceptorpage-reset-to-default==title>>
%%!!pages_interceptorpage-reset-to-default<<
Reset the Intent to its initial state. This may not always work as expected.
%%!!>>

\subsection{Send Edited Intent}\label{subsec:interceptor-send-edited-intent} %%##pages_interceptorpage-send-edited-intent==title>>
%%!!pages_interceptorpage-send-edited-intent<<
