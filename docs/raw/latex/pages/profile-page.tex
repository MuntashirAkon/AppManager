...
\section{Profile Page}\label{sec:profile-page} %%##pages_profilepage-section==title>>
%%!!pages_profilepage-section<<
...
\subsection{Options Menu}\label{subsec:profile-options-menu} %%##pages_profilepage-profile-options-menu==title>>
%%!!pages_profilepage-profile-options-menu<<
...
\subsection{Apps Tab}\label{subsec:profile-apps-tab} %%##pages_profilepage-profile-apps-tab==title>>
%%!!pages_profilepage-profile-apps-tab<<
...
\subsection{Configurations Tab}\label{subsec:profile-configurations-tab} %%##pages_profilepage-profile-configurations-tab==title>>
%%!!pages_profilepage-profile-configurations-tab<<
Configurations tab can be used to configure the selected packages. Description of each item is given below:
%%!!>>

\subsubsection{Comment} %%##pages_profilepage-comment==title>>
%%!!pages_profilepage-comment<<
...
\subsubsection{State}\label{subsubsec:profile-state} %%##pages_profilepage-profile-state==title>>
%%!!pages_profilepage-profile-state<<
...
\subsubsection{Users} %%##pages_profilepage-users==title>>
%%!!pages_profilepage-users<<
Select users for which is the profile will be applied. All users are selected by default.
%%!!>>

\subsubsection{Components} %%##pages_profilepage-components==title>>
%%!!pages_profilepage-components<<
...
\subsubsection{App Ops} %%##pages_profilepage-appops==title>>
%%!!pages_profilepage-appops<<
...
\subsubsection{Permissions} %%##pages_profilepage-permission==title>>
%%!!pages_profilepage-permission<<
...
\subsubsection{Backup/Restore} %%##pages_profilepage-backuprestore==title>>
%%!!pages_profilepage-backuprestore<<
...
\subsubsection{Export Blocking Rules} %%##pages_profilepage-exportblockingrules==title>>
%%!!pages_profilepage-exportblockingrules<<
...
\subsubsection{Disable} %%##pages_profilepage-disable==title>>
%%!!pages_profilepage-disable<<
...
\subsubsection{Force-stop} %%##pages_profilepage-forcestop==title>>
%%!!pages_profilepage-forcestop<<
Allows the selected packages to be force-stopped.
%%!!>>

\subsubsection{Clear Cache} %%##pages_profilepage-clearcache==title>>
%%!!pages_profilepage-clearcache<<
Enables clearing cache for the selected packages.
%%!!>>

\subsubsection{Clear Data} %%##pages_profilepage-cleardata==title>>
%%!!pages_profilepage-cleardata<<
Enables clearing data for the selected packages.
%%!!>>

\subsubsection{Block Trackers} %%##pages_profilepage-blocktrackers==title>>
%%!!pages_profilepage-blocktrackers<<
...
\subsubsection{Save APK} %%##pages_profilepage-saveapk==title>>
%%!!pages_profilepage-saveapk<<
