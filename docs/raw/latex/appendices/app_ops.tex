...
\section{Background}\label{sec:app-ops-background} %%##appendices_appops-background==title>>
%%!!appendices_appops-background<<
...
\section{Introduction to App Ops}\label{sec:introduction-to-app-ops} %%##appendices_appops-introduction==title>>

\begin{figure}[ht]
    \centering
    \includegraphics[width=10cm]{./images/appops}
    \caption{How app ops work} %%##appendices_appops-howappopswork==title>>
    \label{fig:appops}
\end{figure}
%%!!appendices_appops-introduction<<
Figure \cref{fig:appops} describes the process of changing and processing permission.
...
\section{AppOpsManager}\label{sec:appopsmanager} %%##appendices_appops-appopsmanager==title>>
%%!!appendices_appops-appopsmanager<<
...
\subsection{\texttt{OP\_*} Constants}\label{subsec:op-constants} %%##appendices_appops-op-constants==title>>
%%!!appendices_appops-op-constants_1<<
...
public static final int _NUM_OP = 92;
    \end{minted}
    \caption{Sneak-peek of \texttt{OP\_*}} %%##appendices_appops-sneakpeekopconstants==title>>
    \label{lst:op-constants}
\end{listing}

%%!!appendices_appops-op-constants_2<<
...
\subsection{\texttt{MODE\_*} Constants}\label{subsec:mode-constants} %%##appendices_appops-mode-constants==title>>
%%!!appendices_appops-mode-constants<<
...
\subsection{PackageOps}\label{subsec:package-ops} %%##appendices_appops-packageops==title>>
%%!!appendices_appops-packageops_1<<
...
public static class PackageOps implements Parcelable {
    ...
    \end{minted}
    \caption{Class \texttt{PackageOps}} %%##appendices_appops-classpackageops==title>>
    \label{lst:package-ops-class}
\end{listing}

%%!!appendices_appops-packageops_2<<
...
\subsection{OpEntry}\label{subsec:opentry} %%##appendices_appops-opentry==title>>
%%!!appendices_appops-opentry_1<<
...
public static final class OpEntry implements Parcelable {
    ...
    \end{minted}
    \caption{Class \texttt{OpEntry}} %%##appendices_appops-classopentry==title>>
    \label{lst:class-op-entry}
\end{listing}
%%!!appendices_appops-opentry_2<<
Here:
\begin{itemize}
...
\subsection{Usage}\label{subsec:usage} %%##appendices_appops-usage==title>>
TODO

\section{AppOpsService}\label{sec:appopsservice} %%##appendices_appops-appopsservice==title>>
TODO

\section{appops.xml}\label{sec:appops-xml} %%##appendices_appops-appopsxml==title>>
%%!!appendices_appops-appopsxml_1<<
...
\section{Command Line Interface}\label{sec:appops-cli}%%##appendices_appops-appopscli==title>>
%%!!appendices_appops-appopscli<<
